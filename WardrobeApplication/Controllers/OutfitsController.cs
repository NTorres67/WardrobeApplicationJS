...
namespace WardrobeApplication.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        {
            var outfits = db.Outfits.Include(o => o.Accessory).Include(o => o.Bottom).Include(o => o.Occasion).Include(o => o.Season).Include(o => o.Shoe).Include(o => o.Top);
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopID,BottomID,ShoeID,AccessoryID,SeasonID,OccasionID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopID,BottomID,ShoeID,AccessoryID,SeasonID,OccasionID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
